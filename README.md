...
- **Right sidebar:** durable Ask/chat threads with per-thread messages, automatic
  titles until manually renamed, and Ask source scope, plus strictly grounded Markdown answers.
