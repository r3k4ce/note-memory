...
This project was generated by `new-project.sh`.

* Project name: `mapping-memory`
* Primary shell: Bash
...
Use the `.ps1` scripts and `npm.cmd` only when working in a Windows PowerShell environment.
